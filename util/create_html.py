...
if __name__ == "__main__":
    ipList = ["99.102.45.110", "120.24.248.50"]
    domainList = ["www.viewdns.info"]
    projectPath = r"T:\Python Project\Information_Gathering_Tool\project\Demo"
    database = Database(projectPath)
    CreateHtml(database, projectPath, ipList, domainList).start()